...
export const AssignedSubjects = () => {
    ...
    const fetchSubjects = async () => {
        ...
        if (currentUser.teaching_subjects_id.length !== 0) {
        ...
        if (currentUser.teaching_subjects_id.length === 0) {
            return (
                <div>
                    <center>
                        <hr />
                        <h3 className="text-primary fw-bold">📚 Assigned Subjects</h3>
                        <hr />
                        <p className="text-muted">You currently have no assigned Subjects.</p>
                    </center>
                </div>
            );
        } else {
